...
---
_Cross-posted from https://gavinking.substack.com/p/a-preview-of-jakarta-persistence[Substack]._
...
In a previous post I talked about https://in.relation.to/2024/04/01/jakarta-persistence-3/[Jakarta Data]. Alignment of the two specifications has been a further priority.
