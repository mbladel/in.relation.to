...
Hibernate 6.6 includes a complete certified compatible implementation of Jakarta Data 1.0. As https://in.relation.to/2024/04/18/jakarta-data-1/[discussed here], our implementation:
